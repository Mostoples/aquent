...
const I18N = {
  id: {
    ...
    'bnav.aiChat': 'AI Chat',
    'bnav.scan': 'Scan',
    'bnav.control': 'Kontrol',
    'bnav.more': 'Lainnya',
    'qs.gradeA': 'Sangat Baik',
    'qs.gradeB': 'Baik',
    'qs.gradeC': 'Cukup',
    'qs.gradeD': 'Kurang',
    'qs.gradeF': 'Buruk',
    'qs.fPh': 'pH {v}',
    'qs.fTemp': 'Suhu {v}°C',
    'qs.fTurb': 'Kekeruhan {v} NTU',
    'qs.refPh': 'Referensi: 6.5–7.5 (WHO)',
    'qs.refTemp': 'Referensi: 36–38°C (JEADV)',
    'qs.refTurb': 'Referensi: ≤0.5 NTU (WHO)',
  ...
  en: {
    ...
    'qs.gradeF': 'Bad',
    'qs.fPh': 'pH {v}',
    'qs.fTemp': 'Temperature {v}°C',
    'qs.fTurb': 'Turbidity {v} NTU',
    'qs.refPh': 'Reference: 6.5–7.5 (WHO)',
    'qs.refTemp': 'Reference: 36–38°C (JEADV)',
    'qs.refTurb': 'Reference: ≤0.5 NTU (WHO)',
    'ud.dashboard': 'Dashboard',
